...
- [voldikss/vim-floaterm:](https://github.com/voldikss/vim-floaterm) Extension float terminal.
- [akinsho/bufferline.nvim:](https://github.com/akinsho/bufferline.nvim) Extension buffer line in top page.
